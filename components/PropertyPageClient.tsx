...
export default function PropertyPageClient({ slug }: { slug: string }) {
  ...
  const statusLabel: Record<string,string> = { for_sale:'For Sale', for_rent:'For Rent', both:'For Sale & Rent', sold:'Sold', rented:'Rented' }
        ...
        <div className="property-detail-grid">
          <div>
            <span style={{ background:'#C9A96E', color:'#fff', padding:'4px 12px', borderRadius:4, fontSize:11,
              ...
              {statusLabel[property.status] || property.status} · {property.property_type}
            </span>
