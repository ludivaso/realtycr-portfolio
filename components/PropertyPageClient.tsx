...
export default function PropertyPageClient({ slug }: { slug: string }) {
  ...
  if (status === 'notfound') return (
    <div style={{ display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', minHeight:'100vh', background:'#F5F2EE', textAlign:'center', padding:24 }}>
      ...
      <p style={{ color:'#6B6B6B', fontFamily:'Poppins,sans-serif', marginBottom:40 }}>This property does not exist.</p>
  ...
  if (status === 'unavailable') return (
    <div style={{ display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', minHeight:'100vh', background:'#F5F2EE', textAlign:'center', padding:24 }}>
      ...
      <p style={{ color:'#6B6B6B', fontFamily:'Poppins,sans-serif', marginBottom:8 }}>This property has been sold or rented.</p>
      <p style={{ color:'#6B6B6B', fontFamily:'Poppins,sans-serif', marginBottom:40 }}>Esta propiedad ya ha sido vendida o alquilada.</p>
      <Link href="/" style={{ padding:'14px 32px', background:'#C9A96E', color:'#fff', borderRadius:8, textDecoration:'none', fontWeight:500, fontFamily:'Poppins,sans-serif' }}>View Available Properties</Link>
    </div>
  )
  ...
  return (
    <main style={{ background:'#F5F2EE', minHeight:'100vh' }}>
      ...
      <div style={{ maxWidth:1100, margin:'0 auto', padding:'24px' }}>
        ...
        {/* Two-column layout — collapses on mobile via CSS */}
        <div className="property-detail-grid">

          {/* Left — main content */}
          <div>
            <span style={{ background:'#C9A96E', color:'#fff', padding:'4px 12px', borderRadius:4, fontSize:11,
              fontFamily:'Poppins,sans-serif', display:'inline-block', marginBottom:12 }}>
            ...
            {/* Specs strip */}
            <div style={{ display:'flex', gap:24, padding:'20px 0', borderTop:'1px solid #E8E3DC',
              borderBottom:'1px solid #E8E3DC', marginBottom:32, flexWrap:'wrap' }}>
            ...
            {property.plusvalia_notes && (
              <div style={{ padding:24, background:'#fff', borderLeft:'4px solid #C9A96E',
                ...
                <p style={{ fontFamily:'Poppins,sans-serif', fontSize:13, color:'#444', lineHeight:1.8, margin:0 }}>
                  {property.plusvalia_notes}
                </p>
              </div>
            )}
          ...
          {/* Right — price card (moves to top on mobile) */}
          <div className="property-price-card">
            <div style={{ background:'#fff', borderRadius:12, border:'1px solid #E8E3DC', padding:28 }}>
              <p style={{ fontFamily:'Poppins,sans-serif', fontSize:12, color:'#6B6B6B', margin:'0 0 4px',
                textTransform:'uppercase', letterSpacing:1 }}>Asking Price</p>
